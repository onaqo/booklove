    ...
    on_cart_update: function(item){
      setTimeout(function(){
        ...
        var shipp_price =  parseFloat(shipping_price.replace(/[^0-9-.]/g, ''));
         ...
         if(shipp_price == ''){
           $('#free_shipping_price').html('Shipping in almost the whole of UAE is');
        }
          ...
          $('#free_shipping_price').html('Shipping in almost the whole of UAE is<span class="money">AED 15.00</span>');                             
